...
//     protected Swerve m_Swerve;

//     public TeleopDriveCommand(Swerve m_Swerve) {
...
//         //rotFilter.calculate
//         m_Swerve.drive(ChassisSpeeds.fromFieldRelativeSpeeds(driveXFilter.calculate(xSpeed), driveYFilter.calculate(ySpeed), 
//             rotFilter.calculate(rot), m_Swerve.getGyroscopeRotation()));
//         /*m_Swerve.drive(new ChassisSpeeds(driveXFilter.calculate(xSpeed), driveYFilter.calculate(ySpeed), 
